...
CREATE VIEW BuoiHoc
AS
SELECT TietHoc.maLopHoc,TietHoc.idTietHoc,TietHoc.tenPhong,TietHoc.ngayHoc,TietHoc.ghiChu, FROM dbo.TietHoc LEFT JOIN dbo.TietHocBu ON TietHocBu.idTietHoc = TietHoc.idTietHoc
END
GO
SELECT * FROM dbo.TietHoc
